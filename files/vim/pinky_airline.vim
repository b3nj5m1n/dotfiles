...
let g:airline#themes#pinky_airline#palette.insert =
...
let g:airline#themes#pinky_airline#palette.visual =
...
let g:airline#themes#pinky_airline#palette.replace =
...
let g:airline#themes#pinky_airline#palette.inactive =
...
call extend(g:airline#themes#pinky_airline#palette, s:tmp)

let s:warning = s:gen_def(s:dark_gray, s:orangarine)
for mode in keys(g:airline#themes#pinky_airline#palette)
  if mode == 'accents'
    continue
  endif
  let g:airline#themes#pinky_airline#palette[mode]['airline_warning'] = s:warning
endfor
"}}}
